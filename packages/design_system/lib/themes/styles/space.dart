...
class AppSpace {
  ...
  EdgeInsets get containerMobileStart =>
      EdgeInsets.only(left: containerMobile); //
  EdgeInsets get containerMobileEnd =>
      EdgeInsets.only(right: containerMobile); //
  EdgeInsets get containerMobileTop => EdgeInsets.only(top: containerMobile); //
  EdgeInsets get containerMobileBottom =>
      EdgeInsets.only(bottom: containerMobile); //
  EdgeInsets get containerMobileVertical =>
      EdgeInsets.symmetric(vertical: containerMobile); //
  EdgeInsets get containerMobileHorizontal =>
      EdgeInsets.symmetric(horizontal: containerMobile); //

  EdgeInsets get containerDesktopAll => EdgeInsets.all(containerDesktop); //
  EdgeInsets get containerDesktopStart =>
      EdgeInsets.only(left: containerDesktop); //
  EdgeInsets get containerDesktopEnd =>
      EdgeInsets.only(right: containerDesktop); //
  EdgeInsets get containerDesktopTop =>
      EdgeInsets.only(top: containerDesktop); //
  EdgeInsets get containerDesktopBottom =>
      EdgeInsets.only(bottom: containerDesktop); //
  EdgeInsets get containerDesktopVertical =>
      EdgeInsets.symmetric(vertical: containerDesktop); //
  EdgeInsets get containerDesktopHorizontal =>
      EdgeInsets.symmetric(horizontal: containerDesktop); //
