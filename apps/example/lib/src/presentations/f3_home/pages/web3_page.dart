                        ...
                        child: ColumnLayout(
                            ...
                            children: [
                              ...
                              AppText('Mr. Wiggles’ Collection',
                                  style: TextStyle(
                                    color:
                                        context.theme.color.textPrimaryInverse,
                              ...
                              ContainerLayout(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color:
                                            context.theme.color.borderInverse,
                                        width: 0.5),
                                    borderRadius:
                                        ...
                                        RowLayout(gap: 8, children: [
                                          ...
                                          RowLayout(children: [
                                            AppCircleAvatar(
                                                size: WidgetSize.sm,
                                                style: WidgetStyle.subtle,
                                                path: Assets.mock.avatarSquared1
                                                    .keyName),
                                            AppCircleAvatar(
                                                size: WidgetSize.sm,
                                                style: WidgetStyle.subtle,
                                                path: Assets.mock.avatarSquared2
                                                    .keyName),
                                            AppCircleAvatar(
                                                size: WidgetSize.sm,
                                                style: WidgetStyle.subtle,
